-- Script de Investimentos de Teste para Usuário Existente
-- Usando o perfil de Cristian Nunes Macena (super_admin)

-- ========================================
-- 1. INSERIR INVESTIMENTOS DE TESTE
-- ========================================
...
INSERT INTO yields (
  ...
  i.amount * 0.0100,
  0.0100,
  (i.amount * 0.0100) * 0.6, -- 60% para cliente
  (i.amount * 0.0100) * 0.4, -- 40% para empresa
