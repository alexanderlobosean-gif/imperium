-- Migration: Add admin-specific fields to profiles table
-- This script only adds missing columns to existing profiles table
-- Uses existing profiles table instead of creating separate users table
